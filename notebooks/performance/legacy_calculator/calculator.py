...
from .metrics import RatioMetric
...
class SampleSizeCalculator(MultipleTestingMixin):
    ...
    def get_sample_size(self, replication: int, epsilon: float, max_recursion_depth: int) -> float:
        ...
        return self.get_multiple_sample_size(lower, upper, replication, epsilon, max_recursion_depth)
